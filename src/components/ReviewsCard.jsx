  ...
  return (
    <>
      <div className="py-16 text-center">
        <div className="bg-transparent border border-white/20 text-white backdrop-blur-md rounded-xl max-w-[368px] h-[700px] flex flex-col">
          <div className="flex flex-col bg-white/10  rounded-xl h-full">
            ...
            <div className="px-8 flex flex-col h-[280px]">
              ...
              <p className="mt-4 italic text-md text-white flex-1 overflow-hidden">
                {review.review}
              </p>
            </div>
          </div>
