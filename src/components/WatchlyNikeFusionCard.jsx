  ...
  return (
    <>
      <div className="w-full px-4 sm:px-6 lg:hidden">
        <div className="bg-white rounded-xl flex flex-col gap-8 sm:gap-16 md:gap-32 lg:gap-40 md:flex-row items-center py-8 sm:py-12 md:py-16 lg:py-16 justify-center relative overflow-hidden mt-8 lg:mt-0 p-4 lg:p-0 w-full lg:w-auto">
          ...
          <div className="flex flex-col justify-center max-w-md lg:max-w-md z-10 text-center lg:text-left w-full lg:w-auto">
            ...
            <p className="text-center lg:text-center text-sm sm:text-base md:text-lg lg:text-lg text-black mb-4 sm:mb-6 lg:mb-6">
              ...
              high-visibility always-on display, and the integrated Nike Run
              Club app, the new Watchly Nike Fusion pushes you beyond every
              limit: precise workout tracking, a virtual coach, and weekly
              challenges to outdo yourself. Dynamic design, unbeatable
              performance. It's time to run toward new goals.
            </p>
